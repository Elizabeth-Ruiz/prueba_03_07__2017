    ...
    <table id="tablesorter" class="tablesorter" border="0" cellpadding="0" cellspacing="1">
    		<thead>
    			<tr>
    				<th>Carrera</th>
    				<th>Institución</th>
    				<th>Periodo Inicio Acreditación</th>
            <th>Periodo Termino Acreditación</th>
    		...
    		<tbody>
    			...
    			<tr>
    				...
    				<td><?php echo($csv[$a]["periodo_inicio_acreditacion_carrera"])?></td>
            <td><?php echo($csv[$a]["periodo_termino_acreditacion_carrera"])?></td>
...
<p> los datos fueron obtenidos a  través del sitio mifuturo.cl </p>
